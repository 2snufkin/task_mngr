    ...
    return (
        <div className={styles.card} >
                <div className={styles.card_body}>
                    ...
                    <button> <i className="material-icons"  onClick={()=> handleEdit(single_task)} >edit</i> </button>
                    <button><i className="material-icons" onClick={()=> handleDelete(single_task.id)}>delete</i></button>
                </div>
